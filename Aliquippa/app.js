...
require([
    ...
    const combinedBG = new FeatureLayer({
      url: "https://services3.arcgis.com/MV5wh5WkCMqlwISp/arcgis/rest/services/Aliquippa_BG_with_OD/FeatureServer/1",
      id: "Combined_BG",
    ...
    const odTable = new FeatureLayer({
      url: "https://services3.arcgis.com/MV5wh5WkCMqlwISp/arcgis/rest/services/Aliquippa_BG_with_OD/FeatureServer/2",
      id: "OD_Table",
      outFields: ["*"],  // This will fetch all fields
      visible: true,
      opacity: 0.7,
    ...
    const originBG = new FeatureLayer({
        url: "https://services3.arcgis.com/MV5wh5WkCMqlwISp/arcgis/rest/services/Aliquippa_BG_with_OD/FeatureServer/0",
        id: "Origin_BG",
        outFields: ["*"],
        visible: true,
        opacity: 0.7,
