            ...
            if (selectedTime === "ALL") {
                ...
                queryTable.load().then(() => {
                    return queryTable.queryFeatures({
                        where: whereClause,
                        outFields: ["Destination_Zone_ID", "Average_Daily_O_D_Traffic__StL_", "Home_to_Work", "Home_to_Other", "Non_Home_Based_Trip", "Day_Part", "Day_Type"],
                ...
                const query = {
                    where: whereClause,
                    outFields: ["Destination_Zone_ID", "Average_Daily_O_D_Traffic__StL_", "Home_to_Work", "Home_to_Other", "Non_Home_Based_Trip", "Day_Type"],
                    returnGeometry: false
                };
